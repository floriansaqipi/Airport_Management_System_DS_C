        ...
        <TableBody>
          {paginatedAbilities.map(ability => (
            <TableRow key={ability.abilityId}>
              ...
              <TableCell>
                <Link to={`/detail/${ability.abilityId}`}>
                  {ability.entity}
                </Link>
              </TableCell>
              <TableCell>{ability.verb}</TableCell>
              <TableCell>
                <Button variant="contained" color="primary" onClick={() => handleEditAbility(ability)}>
                  Edit
                </Button>
                <Button variant="contained" color="secondary" onClick={() => handleDeleteAbility(ability.abilityId)} style={{ marginLeft: '10px' }}>
                  Delete
                </Button>
              </TableCell>
            </TableRow>
