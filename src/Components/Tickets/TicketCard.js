import styles from "./TicketCard.module.css"; // Import CSS module
...
const TicketCard = ({ ticket }) => {
  const departureTime = dateFormatter(ticket.flight.departureTime)
  const arrivalTime = dateFormatter(ticket.flight.arrivalTime)
        ...
        <div className={styles.receipts}>
          <div className={styles.receipt}>
            <div className={styles["image-container"]}>
              <img src={logo} className={styles["airliner-logo"]} />
            </div>
              ...
              <Grid container>
                <Grid item xs={6}>
                  <div className={styles.item}>
                    <span>Passenger</span>
                    <h3>
                      {ticket.passenger != null ? ticket.passenger.name : "N/A"}
                    </h3>
                  </div>
                </Grid>
                <Grid item xs={6}>
          ...
          <QRCode value={`${JSON.stringify(ticket)}`} className={styles.qr}/>
            {/* <svg
              className={styles.qr}
