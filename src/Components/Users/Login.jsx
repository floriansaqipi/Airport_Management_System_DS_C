        ...
        >
          ...
          >
            <Box sx={{ gap: 2, display: 'flex', alignItems: 'center' }}>
              <IconButton variant="soft" color="primary" size="sm" style={{maxHeight: '5px'}}>
                <img
                src={logo}
                alt="Logo"
                style={{
            ...
            <Stack gap={4} sx={{ mt: 2 }}>
              <form onSubmit={handleLogin}>
                <FormControl>
                  ...
                  {!formInputsValidity.username && <Typography color="error">Username field is empty!</Typography>}
                </FormControl>
                <FormControl>
                  <FormLabel>Password</FormLabel>
                  <Input type="password" name="password" value={password} onChange={(e) => setPassword(e.target.value)} />
                  {!formInputsValidity.password && <Typography color="error">Password field is empty!</Typography>}
                </FormControl>
                <Stack gap={4} sx={{ mt: 2 }}>
